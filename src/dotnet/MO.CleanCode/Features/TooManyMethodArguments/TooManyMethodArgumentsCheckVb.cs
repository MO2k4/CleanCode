...
namespace CleanCode.Features.TooManyMethodArguments
{
    [ElementProblemAnalyzer(
        ...
        HighlightingTypes = new[] { typeof(TooManyArgumentsHighlighting) }
    )]
    public class TooManyMethodArgumentsCheckVb : ElementProblemAnalyzer<IMethodDeclaration>
    {
        ...
        {
            var maxParameters = data.SettingsStore.GetValue(
            ...
            {
                var highlighting = new TooManyArgumentsHighlighting(
