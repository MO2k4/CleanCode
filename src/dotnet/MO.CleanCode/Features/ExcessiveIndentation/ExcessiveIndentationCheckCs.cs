...
namespace CleanCode.Features.ExcessiveIndentation
{
    [ElementProblemAnalyzer(
        ...
        HighlightingTypes = new[] { typeof(ExcessiveIndentHighlighting) }
    )]
    public class ExcessiveIndentationCheckCs : ElementProblemAnalyzer<IMethodDeclaration>
    {
        ...
        {
            var maxIndentation = data.SettingsStore.GetValue(
            ...
            if (childrenDepth > maxIndentation)
            {
                ...
                var highlighting = new ExcessiveIndentHighlighting(
                    documentRange,
                    maxIndentation,
                    childrenDepth
                );
